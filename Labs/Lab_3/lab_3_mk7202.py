...
Original file is located at
    https://colab.research.google.com/drive/19QFgRAYxx9SQm6kAJzyTPT5K62aKm-5p
...
def ReLU(preactivation):
  ...
  preactivation = np.clip(preactivation, 0, 5)
...
def shallow_1_1_3(x, activation_fn, phi_0,phi_1,phi_2,phi_3, theta_10, theta_11, theta_20, theta_21, theta_30, theta_31):
  ...
  a = theta_10 + theta_11* x
  b = theta_20 + theta_21 * x
  c = theta_30 + theta_31 * x
...
"""Please use the below given figure for above parts. Its same as the one in your activity 2. It will also be utilized in activation functions
...
# ANSWER: Changing the phi_0 will change the y-intercept of our graph

# 2. Predict what effect multiplying phi_1, phi_2, phi_3 by 0.5 would have.  Check if you are correct
# ANSWER: That will result in the reduction in the gradients of the piece-wise lines as the phi_1,2,3 act as the gradients in our graph

# 3. Predict what effect multiplying phi_1 by -1 will have.  Check if you are correct.
# ANSWER: The first piece-wise line will be inverted since the gradient has now become negative instead of positive

# 4. Predict what effect setting theta_20 to -1.2 will have.  Check if you are correct.
# ANSWER: The graph in the third piece-wise line will have its height reduced 0.2 points along the y-axis
...
# ANSWER: change the value of theta_20 to 0
...
1.   Answer 1: Changing the phi_0 will change the y-intercept of our graph

2.   Answer 2: That will result in the reduction in the gradients of the piece-wise lines as the phi_1,2,3 act as the gradients in our graph

3.   Answer 3: The first piece-wise line will be inverted since the gradient has now become negative instead of positive

4. Answer 4: The graph in the third piece-wise line will have its height reduced 0.2 points along the y-axis

5. Answer 5: change the value of theta_20 to 0

6. Answer 6: Change theta_10 to 0.5

7.  Answer 7: There will be no change in the graph

8. Answer: 8: That will totally change the entire graph and its gradient and graph will be clipped at height of 0.25
...
# theta_10 =  0.3 ; theta_11 = 1.0
# theta_20 = -5.0  ; theta_21 = 1.0
# theta_30 = -0.5  ; theta_31 = -0.7
# phi_0 = -0.8; phi_1 = 1.5; phi_2 = -1.0; phi_3 = 2.0

# theta_10 =  0.3 ; theta_11 = -1.0
# theta_20 = -1.0  ; theta_21 = 2.0
# theta_30 = -0.5  ; theta_31 = 0.65
# phi_0 = -0.3; phi_1 = 2.0; phi_2 = -1.0; phi_3 = 5.0


theta_10 =  0.2 ; theta_11 = 1.0
theta_20 = -1.0  ; theta_21 = 2.0
theta_30 = -0.5  ; theta_31 = 0.65
phi_0 = -0.67; phi_1 = 1.7; phi_2 = -1.7; phi_3 = 7.0
...
def shallow_2_1_3(x1,x2, activation_fn, phi_0,phi_1,phi_2,phi_3, theta_10, theta_11,
  ...
  y = phi_0 + phi_1*w_act_1 + phi_2*w_act_2 + phi_3*w_act_3
...
"""### For the next part, construct the equation for neural network first and then complete the task. You are not provided with any equation for this one."""
...
# If the plot_all flag is set to true, then we'll plot all the intermediate stages as in activity 2 (also given in image at the start of notebook).
def plot_neural(x, y, pre_1, pre_2, pre_3, act_1, act_2, act_3, w_act_1, w_act_2, w_act_3, plot_all=False, x_data=None, y_data=None):
...
def sigmoid(preactivation):
  ...
  preactivation = 1/ (1+np.exp(-10*preactivation))
  activation = np.zeros_like(preactivation);
  activation = preactivation
  return activation
...
"""1. Answer 1: Equivalent Linear functions

2. Answer 2: The *a* parameter will be determining the gradient/slope of the graph while the *b* parameter will be changing the height
